...
?>
    ...
    <form action="" method="get">
        ...
        <label>Nouvelles infos :<br> <textarea  name="informations"></textarea> </label><br>

        <label for="selection">Nouvelle catégorie :</label>
        <br>
        <br>
        ...
        <br>
        <br>
        <label>Nouveau Stock : <input type="number" name="nbArticle" min="1" max="10000"></label>
        <br>
        <input type="submit">
    </form>
